...
$(function() {
		...
		iDisplayLength: 10,
        ajax: {
			url: '{{ action("SWP\OperationController@postDatatable") }}',
			data: function ( d ) {  
				d.Where={};
        ...
        columns: [
            ...
            {data: 'work_status_swp', title :'สถานะ', className: 'text-center w70', defaultContent: '-', orderable: false},
		...
		rowCallback: function(nRow, aData, dataIndex){
			...
			$('td:last-child', nRow).html(''
				+ '<a href="{{ action("SWP\OperationController@index") }}/'+aData['id']+'/" class="btn btn-xs btn-primary" style="margin:0px;"><i class="fa fa-eye"></i> ดำเนินการ</a> '
			);
		}
    });
