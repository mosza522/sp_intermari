...
@section('content')
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">แจ้งเหตุการณ์หน้าท่า</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
					...
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title"> แจ้งเหตุการณ์หน้าท่า ใบแจ้งงาน  {{ $sRow->work_number }} </h4>
						</div>
						<div class="panel-body form-horizontal">
							<fieldset class="m-t-10">
								<div class="col-md-12 m-b-10" style="min-height:300px;">
									<div class="p-l-0 text-left pull-right m-b-5">
										<a href="#divModal" id="ModalCreated" class="btn btn-sm btn-primary" data-toggle="modal">เพิ่มรายการแจ้งเหตุการณ์หน้าท่า</a>
									</div>
