			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="@if(empty($sRow)) {{ action('Master\SWP\MachineController@store') }}@else {{action('Master\SWP\MachineController@update', $sRow->id )}}@endif" method="POST">
								{{ csrf_field() }}
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class=" col-md-offset-5">
											...
											<a href="{{ action('Master\SWP\MachineController@index') }}" class="btn btn-sm btn-default"> ย้อนกลับ</a>
                                        </div>
                                    </div>
                                </fieldset>
							</form>
