...
@section('content')
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">สายกวาด</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">ข้อมูลสายกวาด</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">จัดการสายกวาด</h4>
                        </div>
						
                        <div class="panel-body">
							<div class="row" style="padding: 0px 2px 0 0;">
								<div class="col-md-8 text-left" >
									<div class="pull-left"><input class="form-control input-sm w250 text-center myLike" name="SweepName" type="text" placeholder="สายกวาด"></div>
								...
								<div class="col-md-4 text-right" >
									<a href="{{ action('Master\FTS\SweepController@create') }}" class="btn btn-sm btn-success">เพิ่มสายกวาด</a>
								</div>
							</div>
...
$(function() {
        ...
        ajax: {
			url: '{{ action("Master\FTS\SweepController@postDatatable") }}',
			data: function ( d ) {  
				d.Where={};
        ...
        columns: [
            ...
            //{data: 'SweepCode', title :'Code', className: 'text-center w80'},
            {data: 'SweepName', title :'สายกวาด', className: 'text-center'},
		...
		rowCallback: function(nRow, aData, dataIndex){
			...
			if( aData['deleted_at'] ){
				...
				$('td:last-child', nRow).html('<a rel="{{ action("Master\FTS\SweepController@index") }}/'+aData['id']+'/?withTrashed=true" class="btn btn-xs btn-warning cDelete" style="margin:0px;"><i class="fa fa-trash-o"></i> กู้คืนข้อมูลที่ลบ</a>');
			}else{
				$('td:last-child', nRow).html(''
					+ '<a href="{{ action("Master\FTS\SweepController@index") }}/'+aData['id']+'/edit" class="btn btn-xs btn-primary" style="margin:0px;"><i class="glyphicon glyphicon-edit"></i> แก้ไข</a> '
					+ '<a rel="{{ action("Master\FTS\SweepController@index") }}/'+aData['id']+'/" class="btn btn-xs btn-danger cDelete" style="margin:0px;"><i class="glyphicon glyphicon-remove"></i> ลบ</a> '
				);
			}
			@if (session('RecordID'))
