			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">การปฏิบัติงานเรือใหญ่</h4>
                        </div>
...
$(function() {
		...
		iDisplayLength: 10,
        ajax: {
			url: '{{ action("FTS\OperationController@postDatatable") }}',
			data: function ( d ) {  
				d.Where={};
        ...
        columns: [
            ...
            {data: 'work_type', title :'ใบงาน', className: 'text-center w50', orderable: false},
            {data: 'BoatName', title :'เรือใหญ่', className: 'text-center w150', orderable: false},
            ...
            {data: 'work_buoy', title :'ทุ่น', className: 'text-center w40', defaultContent: '-', orderable: false},
            //{data: 'work_status_fts', title :'สถานะ', className: 'text-center w70', defaultContent: '-', orderable: false},
		...
		rowCallback: function(nRow, aData, dataIndex){
			...
			$('td:last-child', nRow).html(''
				+ '<a href="{{ action("FTS\OperationController@index") }}/'+aData['id']+'/" class="btn btn-xs btn-primary" style="margin:0px;"><i class="fa fa-eye"></i> ดำเนินการ</a> '
			);
		}
    });
