...
@section('content')
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li>รายการปฏิบัติงานเครน</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">รายการปฏิบัติงานเครน</h1>
			<!-- end page-header -->
					...
					<div class="panel panel-inverse">
						<div class="panel-heading">
							<h4 class="panel-title"><i class="fa fa-rebel"></i>  
								รายการปฏิบัติงานเครน </span>
							</h4>
						</div>
						<form action="{{action('FTS\OperationCraneController@store', array($sRow->OperationID) )}}" method="POST" autocomplete="off">
						{{ csrf_field() }}
						@if( $sRow->id )
						<input type="hidden" name="CraneID" value="{{ $sRow->id }}" />
						@endif
						...
						<div class="panel-heading" style="background: #84b3e6;">
							<h4 class="panel-title">รายการทำงานเครน</h4>
						</div>
						<div class="panel-body form-horizontal">
							<fieldset class="Crane">
								<div class="col-md-12">
									<div class="form-group m-b-10">
										<div class="pull-left m-l-10 " style="width:100%;">
											<div class="pull-left" style="width:50%;">
												...
												<input type="text" style="width: 53%;background-color: transparent;border-color: transparent;" class="form-control pull-left text-center m-r-5"  value="เครน" readonly />
								...
								<div class="col-md-12">
									<div class="form-group m-t-30 m-b-5">
										...
										<div class="col-xs-4 text-center">
											<button type="submit" class="btn btn-sm btn-primary m-r-5">บันทึกการทำงานเครน</button>
