...
$(function() {
		...
		iDisplayLength: 10,
        ajax: {
			url: '{{ action("CLM\OperationController@postDatatable") }}',
			data: function ( d ) {  
				d.Where={};
		...
		rowCallback: function(nRow, aData, dataIndex){
			...
			$('td:last-child', nRow).html(''
				+ '<a href="{{ action("CLM\OperationController@index") }}/'+aData['id']+'/" class="btn btn-xs btn-primary" style="margin:0px;"><i class="fa fa-eye"></i> ดำเนินการ</a> '
			);
		}
    });
