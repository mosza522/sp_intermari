...
class MachineController extends Controller
{
    ...
    public function index()
    {
		...
		return View('FTS.machine_index')->with(array('PageContainer'=> true, 'sRowDepartment'=> $sRowDepartment ) );
    }

    public function checkInspection()
    {
        $sRowDepartment = \App\Models\Staff\Department::where('DivisionID', '6')->get();
		return View('FTS.machine_checkInspection')->with(array('PageContainer'=> true, 'sRowDepartment'=> $sRowDepartment ) );
    }
    ...
    {
        $sRowDepartment = \App\Models\Staff\Department::where('DivisionID', '6')->get();
		return View('FTS.machine_approveInspection')->with(array('PageContainer'=> true, 'sRowDepartment'=> $sRowDepartment ) );
    }
