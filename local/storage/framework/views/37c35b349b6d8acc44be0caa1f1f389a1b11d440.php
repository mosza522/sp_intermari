			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					<li class="nav-profile">
						<div class="image">
							<a href="#"><img src="<?php if(empty(Auth::user()->emp_pic)): ?> assets/img/user-13.jpg <?php else: ?> Picture/Employee/<?php echo e(Auth::user()->emp_pic); ?> <?php endif; ?>" style="transform: scale(1.1);" /></a>
						</div>
						<div class="info">
							<?php echo Auth::user()->StaffPrefix.Auth::user()->StaffFirstName.' '.Auth::user()->StaffLastName; ?>
				...
				<?php if(  $_SERVER['REMOTE_ADDR'] == '::1' ){?>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="<?php echo e(asset(Config::get('app.admin_path'))); ?>/system/admin/">Admin Manager</a></li>
							<li><a href="<?php echo e(asset(Config::get('app.admin_path'))); ?>/system/menu/">Menu Manager</a></li>
						</ul>
					</li>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="<?php echo e(url('machine/indexMachineCondition')); ?>">สภาพเครื่องจักรกล</a></li>
							<li><a href="<?php echo e(url('machine/indexGrab')); ?>">GRAB</a></li>
							<li><a href="<?php echo e(url('machine/indexElectricity')); ?>">เครื่องกำเนิดไฟฟ้า</a></li>
							<li><a href="<?php echo e(url('machine/indexCrane')); ?>">CRANE</a></li>
							<li><a href="<?php echo e(url('machine/indexConveyor')); ?>">กว้านและระบบลำเลียง</a></li>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							<li><a href="<?php echo e(url('fuel/index')); ?>">ถังน้ำมัน</a></li>
							<li><a href="<?php echo e(url('fuel/stock')); ?>">จัดการสต๊อกน้ำมัน</a></li>
							<li><a href="<?php echo e(url('fuel/approve')); ?>">อนุมัติสต๊อกน้ำมัน</a></li>
						</ul>
					</li>
					<?php } ?>
