...
<head>
	<meta charset="utf-8" />
	<title><?php echo e(isset($sTitle) ? $sTitle : 'S.P. Inter Marine Co.,Ltd.'); ?></title>
...
<script src="assets\plugins\select2\dist\js\select2.min.js"></script>
	...
	<link href="assets/plugins/DataTables/extensions/Responsive/css/responsive.bootstrap.min.css" rel="stylesheet" />
  	<link href="assets/plugins/lightbox/css/lightbox.css" rel="stylesheet" /><?php echo $__env->yieldPushContent('css'); ?>
		...
		<div class="modal-dialog">
			<div class="modal-content" style="margin-top: 15%;">
				<div class="modal-header">
					<center><img src="assets/img/<?php echo e(session('alert.status')?session('alert.status'):'success'); ?>.png" width="150" class="m-b-10 m-t-10 "></center>
					<div class="alert alert-<?php echo e(session('alert.status')?session('alert.status'):'success'); ?> m-b-0">
						<div><span id="msg"><?php echo session('alert.msg'); ?></span></div>
					</div>
				</div>
