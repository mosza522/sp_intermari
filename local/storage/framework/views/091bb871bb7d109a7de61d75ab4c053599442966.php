<?php $__env->startSection('content'); ?>
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li>เตรียมความพร้อม ทุ่น, สตีวีโดว์</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">เตรียมความพร้อม ทุ่น, สตีวีโดว์</h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">รายการบันทึกใบแจ้งงาน</h4>
                        </div>
...
$(function() {
		...
		iDisplayLength: 10,
        ajax: {
			url: '<?php echo e(action("FTS\PrepareController@postDatatable")); ?>',
			data: function ( d ) {  
				d.Where={};
		...
		rowCallback: function(nRow, aData, dataIndex){
			...
			$('td:last-child', nRow).html(''
				+ '<a href="<?php echo e(action("FTS\PrepareController@index")); ?>/'+aData['id']+'/" class="btn btn-xs btn-primary" style="margin:0px;"><i class="fa fa-eye"></i> ดำเนินการ</a> '
			);
		}
    });
