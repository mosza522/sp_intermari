                        ...
                        <div class="panel-body">
							<div class="row" style="padding: 0px 2px 0 0;">
								<div class="col-md-12 text-left" >
									<div class="pull-left"><input class="form-control input-sm w150 text-center myLike" name="MachineType" type="text" placeholder="ประเภท"></div>
...
$(function() {
        ...
        columns: [
            {data: 'MachineNunber', title :'วัน-เวลาที่สร้าง', className: 'text-center w80'},
            {data: 'MachineNunber', title :'เลขที่ใบตรวจ', className: 'text-center w80'},
            ...
            {data: 'MachineUsage', title :'ใบแจ้งงาน', className: 'text-center w80'},
            {data: 'MachineUsage', title :'ใบงานเรือใหญ่', className: 'text-center w80'},
            {data: 'MachineUsage', title :'ประเภทการตรวจ', className: 'text-center w100'},
			{data: 'MachineStatus', title :'สถานะการตรวจ', className: 'text-center w100'},
			{data: 'MachineStatus', title :'วัน-เวลาที่ตรวจ', className: 'text-center w100'},
